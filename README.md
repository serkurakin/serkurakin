...
**Data Analysis & ML:** `Pandas` `NumPy` `SciPy` `Scikit-learn` `CatBoost` `XGBoost` `Optuna`

**Deep Learning:** `TensorFlow` / `Keras`

**MLOps & Deployment:** `Docker` `FastAPI` `Streamlit` `Git`
...
<!--
**serkurakin/serkurakin** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
